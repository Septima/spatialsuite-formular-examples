...
<xsl:stylesheet version="1.0"
  ...
  <xsl:attribute-set name="footer-cell" >
	...
	<fo:block font-size="14pt" >
		<xsl:attribute name="margin-top">3mm</xsl:attribute>
		<fo:inline font-weight="bold">Ansøgning om afvikling af arrangementer i telt for mere end 150 personer.</fo:inline>
	</fo:block>
	...
	<fo:block>
		<xsl:attribute name="margin-top">2mm</xsl:attribute>
		Der søges om afvikling af: <xsl:value-of select="$art"/> 
	</fo:block>  
	<fo:block>
		<xsl:attribute name="margin-top">2mm</xsl:attribute>
	...
	<fo:block>
		<xsl:attribute name="margin-top">2mm</xsl:attribute>
		Navn på ansvarlig: <xsl:value-of select="$navn"/> 
	</fo:block>
	<fo:block>
		<xsl:attribute name="margin-top">2mm</xsl:attribute>
		Adresse på ansvarlig: <xsl:value-of select="$adresse2"/> 
	</fo:block>  
	<fo:block>
		<xsl:attribute name="margin-top">2mm</xsl:attribute>
